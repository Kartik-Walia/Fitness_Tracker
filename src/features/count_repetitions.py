...
# Looping over data and create plots to spot repetitions and find patterns of plot 
...
# We can see in the plot that heavy has 5 sets & medium has 10 sets. But we are not sure but it doesnt give complete view, for excercises like bench press it is more useful to look at accelertion data rather than gyroscope data
...
# Trends in plot can be observed by changing the cutoff frequency looking for 5 repetitions in total for heavy  bench press set
...
# Calculates relative extrema of data gives index from original data frame
